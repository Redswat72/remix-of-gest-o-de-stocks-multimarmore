import { Ruler, FileText, ShoppingCart, Check, Layers, Grid2x2, ImageOff, ExternalLink } from 'lucide-react';
      ...
      <CardContent className="p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          {product.numChapas != null && product.numChapas > 0 && (
            <div className="flex items-center gap-2 text-[#C9C3BA]">
              ...
              <span className="text-xs font-medium">{product.numChapas} {t('product.slabs')}</span>
            </div>
          )}
          {product.acabamento && (
            <div className="flex items-center gap-2 text-[#C9C3BA]">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="hidden sm:inline">{t('product.requestQuote')}</span>
            <span className="sm:hidden">{t('product.quote')}</span>
          </Button>
          <Button
            size="sm"
            variant="outline"
