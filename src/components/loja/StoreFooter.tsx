...
export function StoreFooter({ config }: { config: StoreConfig }) {
  ...
  const features = [
    ...
    { icon: Award, label: 'Excelência Premium' },
    ...
    <footer className="py-16 px-6 border-t border-[rgba(30,87,153,0.15)]" style={{ backgroundColor: 'rgba(26, 29, 33, 0.95)' }}>
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4 text-[#1E5799]">Contactos</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4 text-[#1E5799]">Morada</h4>
        ...
        <p className="text-center text-xs text-[rgba(168,173,181,0.5)]">
          © {year} {config.displayName} — Mármores, Granitos & Calcários. Todos os direitos reservados.
        </p>
      </div>
    </footer>
  );
