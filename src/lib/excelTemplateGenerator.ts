...
export const COLUNAS_MODELO = {
  ...
  Peso_ton: { obrigatorio: false, descricao: 'Peso em toneladas (OBRIGATÓRIO para blocos)', exemplo: '12.5' },
...
const INSTRUCOES_DADOS = [
  ...
  { Coluna: 'Parque_MM', Obrigatório: 'SIM', Descrição: 'Código do parque físico onde o material se encontra', Valores_aceites: 'Código existente na tabela de locais (ex: P1, P2)' },
  { Coluna: 'Linha', Obrigatório: 'Não', Descrição: 'Posição interna no parque (linha, corredor, fila)', Valores_aceites: 'Texto livre (ex: A-12, B-05)' },
  ...
  { Coluna: 'Peso_ton', Obrigatório: 'Blocos', Descrição: 'Peso em toneladas (OBRIGATÓRIO para blocos)', Valores_aceites: 'Número positivo (ex: 12.5)' },
...
const NOTAS_INSTRUCOES = [
  ...
  '7. Linha é informação operacional e é guardada no produto (não afeta stock).',
  '8. Erros são apresentados por linha antes da importação final.',
  '',
  '=== VALIDAÇÕES ===',
  '',
  '• ID_MM: Deve ser único e não vazio',
  '• Parque_MM: OBRIGATÓRIO - deve corresponder a um código de parque ativo no sistema',
  '• Linha: Opcional - posição interna no parque (ex: A-12, B-05)',
  '• Variedade: Campo obrigatório, identifica o tipo de pedra',
  '• Peso_ton: OBRIGATÓRIO para produtos do tipo "bloco"',
